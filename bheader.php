...
<!-- Mirrored from bootadmin.org/boxed/ by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 20 Aug 2021 19:47:12 GMT -->
...
<head>
    ...
    <title>
            ...
            Boxed Dashboard &middot; Bootadmin
    ...
    <!-- Le CSS
    ================================================== -->
    <link rel="stylesheet" href="style/vendor/library.min.css">
    <link rel="stylesheet" href="style/vendor/jqueryui-flat/jquery-ui.min.css">
...
<body id="landing" class="boxed sidebar-open">
<div class="loading">
    <div class="loading-center"><img src="images/loading/map.gif" alt="Loading" /></div>
</div>
<div class="page-container animsition">
    <div id="boxedDashboardPage">
